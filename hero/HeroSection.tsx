...
// ═══════════════════════════════════════════════════════════════════════════
        ...
        (function() {
            ...
            if ((!containerLeft && !containerRight) || typeof lottie === 'undefined') return;
            ...
            function initLottie(reentryDelay) {
    ...
    // ═════════════════════════════════════════════════════════════════
    {
            ...
            function buildBrandsTrack(reentryDelay) {
                ...
                for (let i = 0; i < logosOnScreen; i++) {
                    const div = baseDiv.cloneNode(true);
                    ...
                    // Release GPU layer after entry animation completes
