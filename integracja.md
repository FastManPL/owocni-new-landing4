...
<section id="fakty-section">
  <div class="title-block" id="fakty-block">
    <canvas id="fakty-tunnel"></canvas>        <!-- tunnel perspective -->
    <div class="title-dom" id="fakty-dom"></div> <!-- litery FAKTY / SĄ TAKIE -->
    <canvas id="organic-overlay"></canvas>      <!-- organic lines + flares -->
  </div>
</section>
```
...
<div id="blok-4-5-section">
  ...
  <div id="blok-4-5-stars-canvas"></div>  <!-- Three.js WebGL renderer tu się mountuje -->
...
```html
<div class="kinetic-standin" style="position: fixed; top:0; left:0; width:100%; height:100vh; background:#2a2130; z-index:1;">
  <div class="blok3-sim">
...
<div id="bridge-wrapper" style="position: relative; overflow: hidden; height: 100vh;">
...
<div id="blok-4-5-section" style="position: relative; z-index: 2; background: transparent;">
  <!-- Block 4 + Block 5 DOM -->
...
```html
<div style="height: 2100px;"></div>  <!-- SPACER — USUNĄĆ -->
```
```css
.stage-scroll { margin-top: -220vh; }  /* USUNĄĆ */
```
...
4. **P4 Integrator** (P4_INTEGRATOR__3_.md)
5. **Kod Fakty** (fakty_organic_v7.html) — 1008 linii
6. **Kod Kinetic** (index_clean__139_.html) — 4070 linii
7. **Kod Block 4** (blok-4-5-fixed-final__12_.html) — 3574 linii
